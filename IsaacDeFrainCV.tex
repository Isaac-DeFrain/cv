...
% & \emph{Todo}: todo list application exploring first-class modules, functors, and several libraries (\href{https://github.com/Isaac-DeFrain/Todo}{repo}) \\
 & \\
...
% & \\
% & \textbf{Scala} \\
% & Recursive descent parser and regex pattern matcher using matching on parse trees (\href{https://github.com/Isaac-DeFrain/RecursiveDescentParser}{link}) \\
\end{tabular}

\vfill

%\noindent \begin{tabular}{@{} l l}
% \hspace{1.1in} & \textbf{Mathematical Sciences, University of Wisconsin-Eau Claire} \\
% & Classifying complemented subspaces of $L_P, p>2$, 2009 \\
%\end{tabular}
...
\noindent \begin{tabular}{@{} l l}
 \hspace{1.1in} %& Graduate Research Assistant, 2014-2015 \\
